...
###### If you'd like to try this tool for your next DnD session, or you're just curious to play with it, I'll tell you how! You'll want to go to the green button labeled 'code' up at the top of this repo page, and either download and extract the zip, or clone it if you're familiar with git. From the root directory, navigate to  **x64 < Release**  and you will find the .exe there waiting for you!
